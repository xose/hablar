...
public class StoredPreferences extends SimpleStorageData {
	...
	public static StoredPreferences parse(final IQ response) {
		final StoredPreferences parsed = new StoredPreferences(response.getFirstChildInDeep(MatcherFactory.byNameAndXMLNS(HABLAR_PREFERENCES,
				HABLAR_PREFERENCES_XMLNS)));
		return parsed;
	}
