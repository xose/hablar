...
public class SearchBasicActions {
	...
	protected void addAddToRosterAction(final Menu<SearchResultItem> menu) {
		menu.addAction(new SimpleAction<SearchResultItem>(SearchMessages.msg.addToContacts(), ADD_ROSTERITEM_DEB_ID) {
			@Override
	...
	protected void addRemoveFromRosterAction(final Menu<SearchResultItem> menu) {
		menu.addAction(new SimpleAction<SearchResultItem>(SearchMessages.msg.removeFromContacts(), REMOVE_ROSTERITEM_DEB_ID) {
			@Override
			public void execute(final SearchResultItem item) {
	...
	protected void addStartChatAction(final Menu<SearchResultItem> menu) {
		menu.addAction(new SimpleAction<SearchResultItem>(SearchMessages.msg.chat(), CHAT_DEB_ID) {
			@Override
			public void execute(final SearchResultItem item) {
